...
## Environments
- Preview: https://main--netsuite-office--aemysites.aem.page/
- Live: https://main--netsuite-office--aemysites.aem.live/
- Block Library: https://main--netsuite-office--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `netsuite-office` directory in your favorite IDE and start coding :)
